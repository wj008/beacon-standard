...
<div class="yeeui-content">
    <div class="yeeui-optbtns">
        ...
        <div class="search fr">
            ...
            <a id="refresh-btn" href="javascript:window.location.reload()" title="刷新" style="margin-right: 20px"
               class="yee-refresh"><i class="icofont icofont-refresh"></i>刷新</a>
            <a id="add-btn" href="{url act='add'}" class="yee-btn add"><i class="icofont icofont-ui-add"></i>新增表单</a>
        </div>
    </div>
    <div class="yeeui-search">
        <form id="searchform" yee-module="searchform" data-bind="#list">
            ...
            <div class="form-box">
                ...
                <span>{box name="extMode" class="form-inp text" type="select" header='选择类型' options=[[0,'普通'],[1,'插件'],[2,'分层']]}</span>
            </div>
            <div class="form-box">
    ...
    <div class="yeeui-list">
        <table id="list" class="yee-datatable" yee-module="datatable"
            ...
            <tr>
                ...
                <th width="200" align="left">表单名称</th>
                <th width="300" align="left">类型</th>
