...
<div class="yeeui-content">
    ...
    <div class="yeeui-optbtns">
        ...
        <div class="search fr">
            ...
            <a id="add-btn" href="{url act='add'}" onSuccess="$('#list').trigger('reload');" yee-module="dialog" data-width="700" data-height="400" class="yee-btn add"><i class="icofont icofont-ui-add"></i>添加项目</a>
        </div>
    </div>
    ...
    <div class="yeeui-list">
        <table id="list" class="yee-datatable" yee-module="datatable"
            ...
            <tr>
                ...
                <th width="300" align="left">命名空间</th>
