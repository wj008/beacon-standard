...
(function ($, Yee, layer) {
    ...
    function YeeValidate() {
        ...
        var displayError = function (elem, msg) {
            ...
            if (msg) {
                if (validateMode == 1 || validateMode == 2) {
                    return;
                }
                var label = getTipLabel(elem);
        ...
        var initValidator = function (form) {
            ...
            var qform = $(form);
            validateMode = qform.data('validate-mode') || 0;
    ...
    $.fn.extend({
        ...
        showError: function (formError) {
            ...
            for (var name in formError) {
                ...
                firstError = firstError == null ? formError[name] : firstError;
