(function ($, Yee, layer) {
    ...
    function getCode(info, option) {
        ...
        var size = size || option.pageSize;
        var maxpage = parseInt(info.pageCount);
    ...
    Yee.extend('*', 'pagebar', function (elem, option) {
        ...
        qem.on('source', function (ev, source) {
            ...
            qem.find('[v-name="count"]').text(pageinfo.recordsCount);
            qem.find('[v-name="pageCount"]').text(pageinfo.pageCount);
            qem.find('[v-name="page"]').text(pageinfo.page);
            qem.find('[v-name="pageSize"]').text(pageinfo.pageSize);
            qem.find('[v-name="maxPage"]').text(pageinfo.pageCount);
