(function ($, Yee, layer) {
    ...
    function YeeDatatable(qem, option) {
        ...
        this.table_fixed = qem.parent('.yee-datatable-fixed').width(100000);
        $('<div class="yee-datatable-header"></div>').prependTo(this.table_layer);

        /*
        this.table_fixed.get(0).onwheel = function (event) {
        ...
        this.display = function () {
            ...
            if (option && option.fillBottom !== null) {
                $(window).resize(function () {
                    var wheight = $(window).height() - qem.offset().top - option.fillBottom;
